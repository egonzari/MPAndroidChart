...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>>
   ...
   */
  private float mExtraTopOffset = 0.f, mExtraRightOffset = 0.f, mExtraBottomOffset = 0.f,
  ...
  protected float[] eventCanvasPos = new float[2];
  ...
  @Override public float getMaxHighlightDistance() {
  ...
  @Override public float getXChartMax() {
    return mXAxis.mAxisMaximum;
  }

  @Override public float getXChartMin() {
    return mXAxis.mAxisMinimum;
  }

  @Override public float getXRange() {
   ...
   */
  @Override public MPPointF getCenterOffsets() {
   ...
   * related
   * to the description text that is displayed in the bottom right corner of the chart (by
   * default).
   */
  ...
  @Deprecated public boolean isDrawMarkerViewsEnabled() {
   ...
   * Returns a recyclable MPPointF instance.
   */
  @Override public MPPointF getCenterOfView() {
    return getCenter();
  }
  ...
  public boolean saveToGallery(String fileName, int quality) {
    return saveToGallery(fileName, "", "MPAndroidChart-Library Save", Bitmap.CompressFormat.JPEG,
        quality);
  }
