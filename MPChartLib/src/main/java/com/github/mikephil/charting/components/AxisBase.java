...
public abstract class AxisBase extends ComponentBase {
  ...
  protected IAxisImageFormatter mAxisImageFormatter;
  ...
  public void setImageFormatter(IAxisImageFormatter f) {
    this.mAxisImageFormatter = f;
  }
   ...
   * Returns the formatter used for formatting the axis labels.
   */
  public IAxisImageFormatter getImageFormatter() {
    return mAxisImageFormatter;
  }
   ...
   */
  @Deprecated public void setAxisMinValue(float min) {
    setAxisMinimum(min);
  }
   ...
   */
  @Deprecated public void setAxisMaxValue(float max) {
    setAxisMaximum(max);
  }
