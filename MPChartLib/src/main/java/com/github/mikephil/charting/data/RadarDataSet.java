...
public class RadarDataSet extends LineRadarDataSet<RadarEntry> implements IRadarDataSet {
  ...
  /**
   * the colors that are used for filling the radar
   */
  private int[] fillColorArray = null;
  ...
  @Override public boolean isDrawHighlightCircleEnabled() {
    return mDrawHighlightCircleEnabled;
  }

  /// Sets whether highlight circle should be drawn or not
  @Override public void setDrawHighlightCircleEnabled(boolean enabled) {
    mDrawHighlightCircleEnabled = enabled;
  }

  @Override public int getHighlightCircleFillColor() {
  ...
  /// If Utils.COLOR_NONE, the color of the dataset is taken.
  @Override public int getHighlightCircleStrokeColor() {
  ...
  @Override public int getHighlightCircleStrokeAlpha() {
  ...
  @Override public float getHighlightCircleInnerRadius() {
  ...
  @Override public float getHighlightCircleOuterRadius() {
  ...
  @Override public float getHighlightCircleStrokeWidth() {
  ...
  @Override
  public int[] getFillColorArray() {
    return fillColorArray;
  }

  public void setFillColorArray(int[] fillColorArray) {
    this.fillColorArray = fillColorArray;
  }

  @Override public DataSet<RadarEntry> copy() {
